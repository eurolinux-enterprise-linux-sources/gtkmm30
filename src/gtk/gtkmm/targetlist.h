...
public:
  ...
  /** Appends the text targets supported by Gtk::Selection to
  ...
  /** Appends the image targets supported by Gtk::Selection to
   * the target list. All targets are added with the same @a info.
   * 
   * @newin{2,6}
   * @param info An ID that will be passed back to the application.
  ...
  /** Appends the URI targets supported by Gtk::Selection to
   * the target list. All targets are added with the same @a info.
   * 
   * @newin{2,6}
   * @param info An ID that will be passed back to the application.
